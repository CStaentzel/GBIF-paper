# Contributing to GBIF-paper

First off, thanks for taking the time to contribute to `GBIF-paper`!
...
[Contributor Code of Conduct](https://github.com/CStaentzel/GBIF-paper/blob/main/CODE_OF_CONDUCT.md).
By participating, you are expected to uphold this code. Please report 
unacceptable behavior to <cybill.staentzel@engees.unistra.fr>.
...
`GBIF-paper` uses the `lower_snake_case`.
...
[Issues](https://github.com/CStaentzel/GBIF-paper/issues) that might help 
...
- Open a new [Issue](https://github.com/CStaentzel/GBIF-paper/issues/new).
- Use the template [other_issue.md](https://github.com/CStaentzel/GBIF-paper/blob/main/.github/ISSUE_TEMPLATE/other_issue.md).
...
- Make sure that you are using the latest version of `GBIF-paper`.
- Determine if your bug is really a bug and not an error on your side.
- To see if other users have experienced (and potentially already solved) the 
same issue you are having, check if there is not already a bug report existing 
for your bug or error in the [bug tracker](https://github.com/CStaentzel/GBIF-paper/issues?q=label%3Abug).



### How do I submit a bug report?

We use [GitHub Issues](https://github.com/CStaentzel/GBIF-paper/issues) to 
track bugs and errors. If you run into an issue with the project:

- Open a new [Issue](https://github.com/CStaentzel/GBIF-paper/issues/new).
- Use the template [bug_report.md](https://github.com/CStaentzel/GBIF-paper/blob/main/.github/ISSUE_TEMPLATE/bug_report.md).
...
- Make sure that you are using the latest version of `GBIF-paper`.
- Read the [documentation](https://github.com/CStaentzel/GBIF-paper/)
carefully and find out if the functionality is already covered.
- Perform a [search](https://github.com/CStaentzel/GBIF-paper/issues) to 
...
[GitHub Issues](https://github.com/CStaentzel/GBIF-paper/issues).

- Open a new [Issue](https://github.com/CStaentzel/GBIF-paper/issues/new).
- Use the template [feature_request.md](https://github.com/CStaentzel/GBIF-paper/blob/main/.github/ISSUE_TEMPLATE/feature_request.md).
- Provide a clear and descriptive title for the issue to identify the suggestion.
- Provide a step-by-step description of the suggested enhancement in as 
many details as possible.
- Explain why this enhancement would be useful to most `GBIF-paper` users.
...
3. Submit a [Pull Request](https://docs.github.com/en/get-started/quickstart/contributing-to-projects#making-a-pull-request) on the [original repo](https://github.com/CStaentzel/GBIF-paper/compare).
